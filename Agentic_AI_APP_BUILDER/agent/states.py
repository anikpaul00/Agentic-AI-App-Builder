...
# BaseModel isn't an ML model. It's for creating structured results.
...
class Plan(BaseModel):
    ...
    description: str = Field(description="The description of the app to be build, e.g. A web application for perosnal usage")
    techstack: str = Field(description="The tech stack to be used for the app, e.g. 'python', 'javascript','CSS' etc")
